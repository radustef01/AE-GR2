          ...
          {products.map((product) => (
            <div key={product.id} className="group relative">
              <div className="relative">
                ...
                {/* butoane pentru admin (edit / delete) */}
                {isAdmin && (
              ...
              <div className="mt-4 flex flex-col gap-2">
                ...
                {/* buton Add to cart pentru user normal */}
                {!isAdmin && (
                  <button
                    type="button"
                    onClick={() => handleAddToCart(product)}
                    className="mt-1 inline-flex items-center justify-center rounded-md bg-gray-900 px-3 py-2 text-xs font-semibold text-white hover:bg-gray-700"
                  >
                    Add to cart
                  </button>
                )}
